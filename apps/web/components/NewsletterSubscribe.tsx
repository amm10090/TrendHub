...
export const NewsletterSubscribe = () => {
    ...
    const getInputIcon = () => {
        if (email === '') {
            return <IconMailCog className="text-text-secondary-light dark:text-text-secondary-dark" size={20} />;
        }
        if (isInvalid) {
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
                <Input
                    ...
                    classNames={{
                        ...
                        inputWrapper: "border-border-primary-light dark:border-border-primary-dark bg-bg-tertiary-light dark:bg-bg-tertiary-dark",
                        input: "text-text-primary-light dark:text-text-primary-dark placeholder:text-text-secondary-light dark:placeholder:text-text-secondary-dark",
                        clearButton: "text-text-secondary-light dark:text-text-secondary-dark hover:text-text-primary-light dark:hover:text-text-primary-dark",
