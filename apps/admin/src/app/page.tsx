...
import { Button, Card, CardBody, CardFooter, CardHeader, Divider, Navbar, NavbarBrand, NavbarContent } from '@heroui/react';
        ...
        <div className="min-h-screen flex flex-col">
            <Navbar>
                ...
                <NavbarContent className="hidden sm:flex gap-4" justify="center">
                    <Button color="primary" variant="light">仪表盘</Button>
                    <Button color="primary" variant="light">用户管理</Button>
                    <Button color="primary" variant="light">内容管理</Button>
                </NavbarContent>
            </Navbar>
