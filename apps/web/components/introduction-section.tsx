...
import { IconChevronDown, IconChevronUp, IconShieldCheck, IconTruck, IconWallet } from '@tabler/icons-react';
            ...
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className="relative">
                        ...
                        <div className="relative">
                            <div className={`transition-all duration-500 ease-in-out ${isExpanded ? 'max-h-[1000px]' : 'max-h-[80px]'} overflow-hidden`}>
                                <div className="text-center max-w-3xl mx-auto">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-left mb-12">
                                        <div className="space-y-3">
                                            {t('features.left').split('\\n').map((item, index) => (
                                                <p key={index} className="text-sm text-text-secondary-light dark:text-text-secondary-dark">
                                                    • {item}
                                                </p>
                                            ))}
                                        </div>
                                        <div className="space-y-3">
                                            {t('features.right').split('\\n').map((item, index) => (
                                                <p key={index} className="text-sm text-text-secondary-light dark:text-text-secondary-dark">
                                                    • {item}
                                                </p>
                                            ))}
