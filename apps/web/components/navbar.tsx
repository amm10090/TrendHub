          ...
          if (selectedSuggestionIndex >= 0) {
            ...
            if (suggestion.type === 'product') {
              ...
              const productDetailForModal: ProductModalDetailType = {
                ...
                isFavorite: false,
                currency: 'CNY',
                gender: suggestion.gender || undefined,
                categories: [],
                sku: tProduct('defaultSku'),
                status: 'ACTIVE',
                videos: [],
                brandName: suggestion.brandName || undefined,
                brandSlug: suggestion.brandSlug || undefined,
                brandId: suggestion.brandName || 'unknown-brand',
                brandLogo: undefined,
                categoryName: suggestion.categoryName || undefined,
                categorySlug: suggestion.categorySlug || undefined,
