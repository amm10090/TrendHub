...
// 导出适配的 Lucide 图标组件
export const LucideHeartIcon: React.FC<IconSvgProps & { filled?: boolean }> = ({ filled, ...props }) => (
...
export const LucideUserIcon: React.FC<IconSvgProps> = (props) => (
    <User {...adaptProps(props)} />
);
...
export const LucideSunIcon: React.FC<IconSvgProps> = (props) => (
    <Sun {...adaptProps(props)} />
);

export const LucideMoonIcon: React.FC<IconSvgProps> = (props) => (
    <Moon {...adaptProps(props)} />
);
...
export const LucideMenuIcon: React.FC<IconSvgProps> = (props) => (
    <Menu {...adaptProps(props)} />
);

export const LucideCloseIcon: React.FC<IconSvgProps> = (props) => (
    <X {...adaptProps(props)} />
);
...
export const LucidePlusIcon: React.FC<IconSvgProps> = (props) => (
    <Plus {...adaptProps(props)} />
);

export const LucideMinusIcon: React.FC<IconSvgProps> = (props) => (
    <Minus {...adaptProps(props)} />
);
