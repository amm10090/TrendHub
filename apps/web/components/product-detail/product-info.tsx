        ...
        <div className="flex flex-col space-y-4">
            ...
            <div className="flex items-center gap-4 mt-2">
                <div className="flex items-baseline gap-2">
                    <span className={`text-xl md:text-2xl font-medium ${hasDiscount ? 'text-red-600 dark:text-red-400' : 'text-text-primary-light dark:text-text-primary-dark'}`}>
                ...
                {product.isNew && (
                    <Chip
                        classNames={{
                            ...
                            content: 'text-xs font-medium px-2 py-0.5 text-text-primary-light dark:text-text-primary-dark',
                        }}
                        variant="flat"
                    >
                        {t('tags.new')}
