...
export const SearchIcon: React.FC<IconSvgProps> = ({ className }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const UserIcon: React.FC<IconSvgProps> = ({ className }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const ShoppingBagIcon: React.FC<IconSvgProps> = ({ className }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
