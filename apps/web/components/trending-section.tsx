    ...
    return (
        ...
        >
            <div className={`${isHorizontal ? 'lg:flex' : ''}`}>
                ...
                <CardFooter className={`flex flex-col items-start p-6 ${isHorizontal ? 'lg:w-1/3 lg:justify-center' : ''}`}>
                    <h3 className={`${size === 'large' || size === 'horizontal' ? 'text-2xl' : 'text-lg sm:text-xl'} font-bold text-text-primary-light dark:text-text-primary-dark text-center w-full`}>
                        {title}
                    </h3>
