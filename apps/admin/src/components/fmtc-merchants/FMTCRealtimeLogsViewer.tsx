...
interface FMTCRealtimeLogsViewerProps {
  executionId: string;
  taskName: string;
  onClose: () => void;
...
export function FMTCRealtimeLogsViewer({
  ...
  const t = useTranslations("fmtcMerchants.scraper.realtimeLogsViewer");
  ...
  const createEventSource = useCallback(() => {
    ...
    const eventSource = new EventSource(
      `/api/fmtc-merchants/scraper/logs/stream?${params.toString()}`,
    );
